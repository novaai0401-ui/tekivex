...
const FAQS: QA[] = [
  {
    q: 'What is Tekivex?',
    a: 'Tekivex is an independent developer-tools project that publishes open-source enterprise software — GridStorm (data grid), Analytics Studio (BI), DataFlow (real-time streaming), PDF Toolkit, and Tekivex UI. All of our products are MIT licensed.',
  },
  {
